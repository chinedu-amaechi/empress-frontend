// src/app/ui/WishlistDropdown.js
...
const WishlistDropdown = () => {
  ...
  const [wishlistDropdownPosition, setWishlistDropdownPosition] = useState({
    top: 0,
    left: 0,
  });
  ...
  const wishlistDropdownContent = wishlistDropdown && (
    <div
      className="absolute top-14 left-10 w-fit bg-white border shadow-lg"
      style={{
        top: wishlistDropdownPosition.top,
        left: wishlistDropdownPosition.left,
      }}
    >
      <div
...
const WishlistItem = () => {
  return (
    <div className="p-2 hover:bg-gray-200 cursor-pointer w-fit">
      <div className="flex flex-row">
        ...
        <div className="flex flex-col px-2">
          ...
          <h1 className="text-xl px-2">$30</h1>
        </div>
      </div>
    </div>
  );
